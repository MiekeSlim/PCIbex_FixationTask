...
PennController.Template("FixationTrials.csv",
    row => PennController("Trials", 
        ...
        newCanvas("FixationCross", "100vw", "100vh") // Tracked canvases are slighlty larged than the fixation cross (note that we use 'vh' to determine the canvas width as well, so it's a square)
            .add("center at 50%", "middle at 50%", newText("<p>+</p>").css("font-size", "15vh"))
            .add("middle at 95%", "center at 5%", newText("<p>+</p>").css("font-size", "15vh"))
            .add("middle at 5%", "center at 5%", newText("<p>+</p>").css("font-size", "15vh"))
            .add("middle at 95%", "center at 95%", newText("<p>+</p>").css("font-size", "15vh"))
            .add("middle at 5%", "center at 95%", newText("<p>+</p>").css("font-size", "15vh"))
            .add("middle at 95%", "center at 50%", newText("<p>+</p>").css("font-size", "15vh"))
            .add("middle at 50%", "center at 95%", newText("<p>+</p>").css("font-size", "15vh"))
            .add("middle at 5%", "center at 50%", newText("<p>+</p>").css("font-size", "15vh"))
            .add("middle at 50%", "center at 5%", newText("<p>+</p>").css("font-size", "15vh"))
            .add("middle at 50%", "center at 50%", newText("<p>+</p>").css("font-size", "15vh"))
            .add("middle at 25%", "center at 25%", newText("<p>+</p>").css("font-size", "15vh"))
            .add("middle at 75%", "center at 25%", newText("<p>+</p>").css("font-size", "15vh"))
            .add("middle at 25%", "center at 75%", newText("<p>+</p>").css("font-size", "15vh"))
            .add("middle at 75%", "center at 75%", newText("<p>+</p>").css("font-size", "15vh"))
            .print(0,0)
            .wait()         
    )
